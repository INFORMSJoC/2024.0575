...
class SYNTHETICVMI(Model):
    def __init__(self, fixed_factors={}):
        self.name = "SYNTHETICVMI"
        self.n_rngs = 1
        self.n_responses = 1
        self.specifications = {
            "dim": {
...
class SYNTHETICVMI_MIN(Problem):
    def __init__(self, name="SYNVMI-1", fixed_factors={}, model_fixed_factors={}):
        self.name = name
        self.n_objectives = 1
        ...
        self.model = SYNTHETICVMI(self.model_fixed_factors)
