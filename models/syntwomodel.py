...
class SYNTHETICTWOMODEL(Model):
    ...
    def replicate(self, rng_list):
        ...
        for i in range(d):
            sigma = math.sqrt(abs((x[0] - 3) * (x[1] - 2)))
...
class SYNTHETICTWOMODEL_MIN(Problem):
    def __init__(self, name="SYNTWOMODEL-1", fixed_factors={}, model_fixed_factors={}):
        self.name = name
        self.n_objectives = 1
        ...
        self.model = SYNTHETICTWOMODEL(self.model_fixed_factors)
