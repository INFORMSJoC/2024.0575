...
class ASTRODFRPQIT(Solver):
    """ ASTRO-DF for figure 13 
    Attributes
    ----------
    name : string
        name of solver
    ...
    base.Solver
    """
    def __init__(self, name="ASTRODFRPQIT", fixed_factors=None):
            ...
            for i in range(2 * problem.dim + 1):
                ...
                # for new points, we need to run the simulation
                    ...
                    while True:
                        ...
                        if sample_size >= self.get_stopping_time(k, sig2, delta_k, kappa, problem.dim) or expended_budget >= budget:
                            break
                    fval.append(-1 * problem.minmax[0] * design_point_solution.objectives_mean)
    ...
    def solve(self, problem):
        ...
        if problem.name == 'MAXCUT-1':
            file_name_function = 'figures/function_maxcut_astro.npy'
