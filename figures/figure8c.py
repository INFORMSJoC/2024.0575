...
for solver in solvers:
    ...
    if solver == "VMI3-0-cv10":
        ...
        solver_name = "VMI-ASTRO-DF-2"
    elif solver == "VMI1-0":
        solver_name = "VMI-ASTRO-DF-1"
...
plot_solvability_profiles(myexperiment, plot_type="cdf_solvability", solve_tol=0.001, all_in_one=True, plot_CIs=True, print_max_hw=True)
