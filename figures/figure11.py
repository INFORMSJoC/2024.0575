...
from wrapper_base_onlylog import Experiment, read_experiment_results, post_normalize, plot_progress_curves, plot_solvability_cdfs, plot_solvability_profiles

m = 20 # Macro-replication
L = 200 # Post-replication

solvers = ["VMI3-1000-cv10", "ASTRODFRPQ-1000", "NELDMDQ-1000", "SPSAQ-1000"] # Figure 11
problem_name = "SYN-1"
