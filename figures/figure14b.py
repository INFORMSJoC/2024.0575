...
from wrapper_base import Experiment, read_experiment_results, post_normalize, plot_progress_curves, plot_solvability_cdfs, plot_solvability_profiles
...
for solver in solvers:
    ...
    if solver == "VMI3PF-0-cv10":
        solver_name = "VMI-ASTRO-DF-3 with regularized function"
    elif solver == "ASTRODFRPQPF-0":
        solver_name = "ASTRO-DF with regularized function"
...
plot_solvability_profiles(myexperiment, plot_type="cdf_solvability", solve_tol=0.1, all_in_one=True, plot_CIs=True, print_max_hw=True)
