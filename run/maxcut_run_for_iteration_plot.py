"""
Generate .pickle fils in /experiments/outputs (figure 13b)
"""
import sys
import os.path as o
import os
...
from simopt.experiment_base import ProblemSolverIT, post_normalize
...
def main():
    ...
    for solver in solvers:
        ...
        myexperiment = ProblemSolverIT(iteration_num = 31,
